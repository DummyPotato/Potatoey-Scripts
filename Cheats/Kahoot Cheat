...
/*How to use: You must be on a question page, from there run the code and it will ask you a couple questions. From there it will auto answer
for you on every question*/

debugger;
if (document.location.href.search("kahoot.it/challenge") == -1) {
    throw new Error("Error, You aren't on a kahoot challenge.");
}
